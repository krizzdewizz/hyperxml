...
public class Xml<T extends Xml<?>> {
   ...
   * <p>
   * Note that {@link #setContentHandler(ContentHandler)} must be called before
   * the xml is created or else a {@link HyperXmlException} will occur.
   */
  public Xml() {
    this(null);
  }
   ...
   * and an optional value. If the last argument is {@link @#$}, will call
   * {@link #$()} just after starting the element (auto-end).
   * <p>
   * <img border="1" src="doc-files/sugar4xml_element_method.png">
   * 
   * @param name
   ...
   *          value.If the last argument is {@link @#$}, will call {@link #$()}
   *          just after starting the element (auto-end). If the length of the
   *          array is odd, the last element designates the value for the
   *          element. May be empty. An attribute name may be
   *          namespace-prefixed.
   * @return <code>this</code>
   ...
   *          designates the value for the element. May be empty. An attribute
   *          name may be namespace-prefixed.
   * @return <code>this</code>
   */
